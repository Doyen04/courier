  ...
  return (
    <main className="support-workspace-shell min-h-screen bg-[#fbfaf7] text-courier-ink">
      <header className="sticky top-0 z-40 border-b border-courier-line bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex min-h-[72px] max-w-[1180px] items-center justify-between gap-4 px-5 sm:px-8">
          <BrandMark />
      ...
      <div className="mx-auto max-w-[1320px] px-5 pb-16 pt-8 sm:px-8 sm:pt-12 lg:px-12">
