...
function RouteIllustration() {
    return (
        <div className="relative mx-auto aspect-[1.1/1] w-full max-w-135 overflow-hidden rounded-[34px] bg-[#f6f0e5] p-5 sm:p-7" aria-label="Illustration of a parcel joining a travel route">
...
function RouteMatchPreview() {
    return (
        <div className="rounded-4xl bg-courier-green p-4 sm:p-7" role="img" aria-label="Example route match between a Lagos item request and an Abuja trip">
...
function ParcelScene() {
    return (
        <svg viewBox="0 0 210 175" className="parcel-scene-graphic h-30 w-36.25 shrink-0 sm:h-43.5 sm:w-51.25" fill="none" role="img" aria-label="A wrapped parcel ready to travel">
...
function TravelerScene() {
    return (
        <svg viewBox="0 0 210 175" className="traveler-scene-graphic h-30 w-36.25 shrink-0 sm:h-43.5 sm:w-51.25" fill="none" role="img" aria-label="A traveler following a planned route">
...
function HandoffScene() {
    return (
        <div className="relative z-10 overflow-hidden rounded-4xl bg-[#f3e8d3] p-4 sm:p-7" role="img" aria-label="Illustration of two people meeting to hand over a parcel">
    ...
    return (
        <main id="top" className="min-h-screen overflow-hidden bg-white text-courier-ink">
            <header className="sticky top-0 z-40 border-b border-courier-line bg-white/95 backdrop-blur-md">
                <div className="mx-auto flex min-h-19 w-full max-w-330 items-center justify-between px-5 sm:px-8 lg:px-12">
                    <BrandMark />
            ...
            <section className="relative overflow-hidden bg-courier-green text-white" aria-labelledby="hero-title">
                    <div className="hero-orbit absolute -right-32 -top-48 size-117.5 rounded-full border border-white/10 sm:size-155" aria-hidden="true" />
                    <div className="hero-orbit hero-orbit-slower absolute -right-8 -top-24 size-82.5 rounded-full border border-white/10 sm:size-117.5" aria-hidden="true" />
                <div className="relative mx-auto grid w-full max-w-330 items-center gap-10 px-5 py-14 sm:px-8 sm:py-20 lg:min-h-177.5 lg:grid-cols-[.92fr_1.08fr] lg:gap-14 lg:px-12 lg:py-24">
                    <div className="animate-enter max-w-150">
                        <h1 id="hero-title" className="max-w-160 text-[clamp(3rem,6vw,5.5rem)] font-bold leading-[.99] tracking-[-.06em] text-white">
                            Send with someone <span className="text-[#f1d39a]">already headed there.</span>
                        </h1>
                        <p className="mt-6 max-w-125 text-[16px] leading-7 text-white/80 sm:text-[18px] sm:leading-8">
                    ...
                    <div className="animate-enter-delayed relative w-full lg:justify-self-end lg:max-w-150">
                        <RouteIllustration />
            ...
            <section className="border-b border-courier-line bg-[#fbfaf7]" aria-label="Courier commitments">
                <div className="mx-auto grid max-w-330 gap-5 px-5 py-7 sm:grid-cols-3 sm:px-8 sm:py-8 lg:px-12">
            ...
            <section id="how-it-works" className="mx-auto max-w-330 px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28">
                <div className="mb-10 flex flex-col justify-between gap-5 border-b border-courier-line pb-7 sm:flex-row sm:items-end">
                    <div>
                        ...
                        <h2 className="mb-0 max-w-170 text-[clamp(2.2rem,4vw,3.7rem)] font-semibold leading-[1.04] tracking-tighter">A good handoff starts with a good match.</h2>
                    </div>
                    <p className="mb-1 max-w-97.5 text-[14px] leading-6 text-courier-muted">Each person chooses what works for them, from the route to the meetup plan.</p>
                </div>
                <div className="grid gap-4 md:grid-cols-3">
                    {steps.map((step, index) => (
                            ...
                            <p className={`mb-0 max-w-77.5 text-[14px] leading-6 ${index === 1 ? "text-white/75" : "text-courier-muted"}`}>{step.text}</p>
                        </article>
                    ))}
                </div>
            </section>
            ...
            <section className="overflow-hidden bg-[#f6f0e5]" aria-labelledby="match-title">
                <div className="mx-auto grid max-w-330 items-center gap-10 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[.86fr_1.14fr] lg:gap-16 lg:px-12 lg:py-24">
                    <div>
                        <p className="mb-3 text-[11px] font-bold uppercase tracking-[.15em] text-courier-green">Routes that line up</p>
                        <h2 id="match-title" className="mb-5 max-w-130 text-[clamp(2.1rem,4vw,3.5rem)] font-semibold leading-[1.04] tracking-tighter">One shared route can make the difference.</h2>
                        <p className="mb-7 max-w-115 text-[14px] leading-6 text-courier-muted sm:text-[15px]">Add the destination and timing. Courier helps surface trips that could suit the request, so both people can decide if the details fit.</p>
            ...
            <section id="for-everyone" className="mx-auto max-w-330 px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28">
                <div className="mb-10 grid gap-5 md:grid-cols-[1fr_.7fr] md:items-end">
                    <div>
                        ...
                        <h2 className="mb-0 max-w-170 text-[clamp(2.1rem,4vw,3.5rem)] font-semibold leading-[1.04] tracking-tighter">A useful connection for both of you.</h2>
                    </div>
                </div>
                <div className="grid gap-5 lg:grid-cols-2">
                    ...
                    <article className="reveal-on-scroll group overflow-hidden rounded-[30px] border border-[#d6e2d9] bg-white transition-transform duration-300 hover:-translate-y-1">
                        <div className="flex min-h-62.5 flex-col items-start justify-between gap-3 overflow-hidden bg-[#eaf1eb] px-6 py-6 sm:min-h-55 sm:flex-row sm:items-center sm:gap-4 sm:px-9 sm:py-7">
                            <div className="max-w-70"><span className="mb-4 inline-flex rounded-full bg-white px-3 py-1.5 text-[10px] font-bold uppercase tracking-[.12em] text-courier-green">For travelers</span><p className="mb-0 text-[23px] font-semibold leading-tight tracking-[-.04em] text-courier-ink sm:text-[28px]">Already on your way?</p></div>
                            <TravelerScene />
                        </div>
                        <div className="px-6 py-7 sm:px-9 sm:py-8">
            ...
            <section id="handoff" className="overflow-hidden bg-courier-green text-white" aria-labelledby="handoff-title">
                <div className="relative mx-auto grid max-w-330 items-center gap-10 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[.9fr_1.1fr] lg:gap-16 lg:px-12 lg:py-24">
                    <div className="absolute -left-32 -top-32 size-105 rounded-full border border-white/10 sm:size-140" aria-hidden="true" />
                    <div className="relative z-10">
                        <p className="mb-3 text-[11px] font-bold uppercase tracking-[.15em] text-[#f1d39a]">Clear from agreement to arrival</p>
                        <h2 id="handoff-title" className="mb-5 max-w-137.5 text-[clamp(2.2rem,4.2vw,3.8rem)] font-semibold leading-[1.03] tracking-tighter">The details matter. Keep them in the open.</h2>
                        <p className="mb-8 max-w-122.5 text-[14px] leading-6 text-white/75 sm:text-[15px]">Both people review the item, fee, and handoff plan before moving ahead. Once they meet, the requester confirms whether the item arrived.</p>
            ...
            <section className="mx-auto max-w-330 px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28" aria-labelledby="faq-title">
                <div className="grid gap-10 md:grid-cols-[.72fr_1.28fr] md:gap-20">
                    <div>
                        ...
                        <h2 id="faq-title" className="mb-0 max-w-102.5 text-[clamp(2.1rem,4vw,3.5rem)] font-semibold leading-[1.04] tracking-tighter">Good to know before you go.</h2>
                    </div>
                    <div className="divide-y divide-courier-line border-y border-courier-line">
                        <details className="group py-5 sm:py-6">
                            ...
                            <p className="mb-0 mt-3 max-w-155 text-[13px] leading-6 text-courier-muted">Courier is designed to connect a request with a traveler who is already planning to go that way.</p>
                        </details>
                        <details className="group py-5 sm:py-6">
                            ...
                            <p className="mb-0 mt-3 max-w-155 text-[13px] leading-6 text-courier-muted">The traveler proposes a fee. The requester reviews and accepts the full terms before the agreement proceeds.</p>
                        </details>
                        <details className="group py-5 sm:py-6">
                            ...
                            <p className="mb-0 mt-3 max-w-155 text-[13px] leading-6 text-courier-muted">The requester confirms receipt after the handoff. The traveler cannot confirm delivery on the requester&apos;s behalf.</p>
                        </details>
                        <details className="group py-5 sm:py-6">
                            ...
                            <p className="mb-0 mt-3 max-w-155 text-[13px] leading-6 text-courier-muted">Yes. One account lets you post item requests and share journeys.</p>
                        </details>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-courier-gold text-courier-ink">
                <div className="mx-auto flex max-w-330 flex-col gap-7 px-5 py-14 sm:px-8 sm:py-16 md:flex-row md:items-center md:justify-between lg:px-12 lg:py-20">
